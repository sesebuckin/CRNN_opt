...
from tensorflow.contrib import learn  # 一个高级API
...
"""
params:
-bottom: the inputs of the layer
-training: the mode of train (in tf.contrib.learn)
"""
...
def convnet_layers(inputs, widths, mode):
    ...
    with tf.variable_scope("convnet"):  # h,w
        ...
        after_conv1 = tf.subtract(widths, conv1_trim)  # 减法
